...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase Contact @iAmLiKu1 (admin) to add This Movie file📂')
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ Can't Access ❓ Click Here ⚠️", url=f'https://t.me/+v76S04jMYPQ2NDI1')
                        ]
                    ]
                )
            )
